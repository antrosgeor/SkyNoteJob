<h1><?php echo $_SESSION['Value_Contact_Admin']; ?></h1>
...
<div class="row"><!-- Start row -->
	...
	<form action="index.php?page=contact/contact_admin" method="post" role="form"><!-- Start form -->
		...
		<div class="form-group">
			<label class="list-group-item list-group-item-info" for="to"><?php echo $_SESSION['Value_Sent_message_to']; ?> : </label>
