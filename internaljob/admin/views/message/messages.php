...
<div class = "container"><!-- Start div container -->
	<h1><i><?php echo $_SESSION['Messages']; ?></i></h1>  
<br>
...
<a class="list-group-item list-group-item-success"  href="?page=message/messages_unread">  
	<?php
		$sql = "SELECT * FROM messages WHERE marked = 'UNREAD' AND (admin_to = '$userid' OR admin_to = 0) ORDER BY date  DESC";
...
<div class="row"><!-- Start div row -->
	...
	<a class="list-group-item list-group-item-success"  href="?page=message/messages_read">  
	 	<?php 
...
<div class="row"><!-- Start div row -->
	...
	<a class="list-group-item list-group-item-success"  href="?page=message/messages_send">  
	 	<?php 
