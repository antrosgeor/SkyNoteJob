...
//edo tha mporousa efoso einai to $_SESSION['test'] == "Member" na trexei aftomata to logout tou member
	if (!isset($_SESSION['username']) OR $_SESSION['test'] == "Member") { header('Location: login.php'); }
?>
